  ...
  return (
    <section className={styles.section}>
      ...
      <div className={styles.header}>
        ...
        <p>HARD METRICS FROM 12 MONTHS POST-LAUNCH.</p>
      </div>
      ...
      <div className={styles.testimonial}>
        <span className={styles.tag}>CLIENT TESTIMONIAL</span>

        <p className={styles.quote}>
          "WORKING WITH THIS TEAM CHANGED EVERYTHING. WE WENT FROM A 'CLEANING
          BUSINESS' TO A TECH-ENABLED SERVICE COMPANY. OUR REVENUE IS UP, AND
          OUR STRESS IS DOWN."
        </p>
