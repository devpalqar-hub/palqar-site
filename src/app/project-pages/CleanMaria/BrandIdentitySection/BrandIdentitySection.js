        ...
        <div className={styles.header}>
          <div>
            ...
            <p>
              ...
              freshness, and high-end service. The palette of Deep Blue, Vibrant
              Green, and Professional Grey creates a balanced, trustworthy
              presence.
            </p>
          </div>
        ...
        <div className={styles.topGrid}>
          ...
          <div className={styles.typeCard}>
            ...
            <p className={styles.sub}>
              Geometric sans-serif for maximum legibility and modern aesthetic.
            </p>

            <div className={styles.typeSample}>AaBb Cc</div>
