...
export default function Showcase() {
  ...
  useGSAP(() => {
     ...
     */
    const SLOTS = [
      { n: 0.000, x: 0,   scale: 1.00, rotateY:   0, y:  0, opacity: 1.0 },
      { n: 0.125, x: 295, scale: 0.82, rotateY: -32, y:  8, opacity: 1.0 },
      { n: 0.250, x: 530, scale: 0.66, rotateY: -56, y: 22, opacity: 1.0 },
      { n: 0.375, x: 700, scale: 0.53, rotateY: -68, y: 40, opacity: 0.75 },
      { n: 0.500, x: 820, scale: 0.42, rotateY: -75, y: 58, opacity: 0.0 }, // hidden (back)
    ];
